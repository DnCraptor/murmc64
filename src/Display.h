...
#ifdef FRODO_RP2350
// On RP2350, Display is defined in Display_rp2350.h
// Forward declaration only here
#include "rp2350/Display_rp2350.h"
#else
// Class for C64 graphics display (SDL version)
class Display {
public:
	Display(C64 * c64);
	~Display();
